...
RUNTIME_CONTRACT_EXPECT_SKILL="${RUNTIME_CONTRACT_EXPECT_SKILL:-smoke-skill}"
RUNTIME_CONTRACT_EXPECT_LEGACY_TOOL="${RUNTIME_CONTRACT_EXPECT_LEGACY_TOOL:-${RUNTIME_CONTRACT_EXPECT_TOOL:-smoke_tool}}"
RUNTIME_CONTRACT_EXPECT_OPENCODE_TOOL="${RUNTIME_CONTRACT_EXPECT_OPENCODE_TOOL:-${RUNTIME_CONTRACT_EXPECT_EFP_TOOL:-efp_smoke_tool}}"
...
run_runtime_contract_tests() {
  ...
  timeout "${RUNTIME_CONTRACT_TIMEOUT_SECONDS}" env \
    RUNTIME_BASE_URL="${RUNTIME_CONTRACT_BASE_URL}" \
    RUNTIME_CONTRACT_EXPECT_SKILL="${RUNTIME_CONTRACT_EXPECT_SKILL}" \
    RUNTIME_CONTRACT_EXPECT_LEGACY_TOOL="${RUNTIME_CONTRACT_EXPECT_LEGACY_TOOL}" \
    RUNTIME_CONTRACT_EXPECT_OPENCODE_TOOL="${RUNTIME_CONTRACT_EXPECT_OPENCODE_TOOL}" \
    RUNTIME_CONTRACT_EXPECT_TOOL_MAPPING="${RUNTIME_CONTRACT_EXPECT_TOOL_MAPPING}" \
    RUNTIME_CONTRACT_EXPECT_TOOL="${RUNTIME_CONTRACT_EXPECT_TOOL}" \
    RUNTIME_CONTRACT_EXPECT_EFP_TOOL="${RUNTIME_CONTRACT_EXPECT_EFP_TOOL}" \
